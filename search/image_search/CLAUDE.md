...
7. Evaluation (model and system evaluation)
...
build a image search system, the system retrieves images similar to the query image provided by user, rank them bases on similarity to the query image, and then display to the user. The system only supports image, no video or audio. 
all content is in "image_search" folder

<!-- Project Three: build a video search system like youtube, put all docs in "video_search" folder.  -->
