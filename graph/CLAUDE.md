...
Build a "people you may know" system similar to LinkedIn's, the system takes a user as input and recommend a list of potential connections as output. 

Let's try use mordern ML approach, such as GNN and further advanced model if possible. Please give me the options and trade-off, since I'm not familiar with graph in ML, please also cover the basic first, so I could understand easily. 
